...
<%!
	...
	Statement stmt;
	ResultSet rs;
	String roll_number,dt,name,image,address,phone,email,course,certificate_no,status_code,college,cls,batch,issue_date,dt1,dt2,comment;
%>
<BODY bgcolor="yellow">
...
<%
	try
	{
		...
		dt1=request.getParameter("dt1");
		dt2=request.getParameter("dt2");
		rs=stmt.executeQuery("select * from tform where issue_date between '"+dt1+"' and '"+dt2+"';");
		while(rs.next())
		{
